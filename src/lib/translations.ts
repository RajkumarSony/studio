...
export const translations: Record<LanguageCode, TranslationMessages> = {
  en: {
    ...
    form: {
      ...
      preferencesPlaceholder: 'e.g., spicy, Italian cuisine',
  ...
  hi: {
    ...
    form: {
      ...
      preferencesPlaceholder: 'जैसे, मसालेदार, इतालवी व्यंजन',
  ...
  bn: {
    ...
    form: {
        ...
        preferencesPlaceholder: 'যেমন, মশলাদার, ইতালীয় রান্না',
  ...
  mr: {
      ...
      form: {
          ...
          preferencesPlaceholder: 'उदा. मसालेदार, इटालियन पाककृती',
  ...
  ta: {
      ...
      form: {
          ...
          preferencesPlaceholder: 'எ.கா., காரமானது, இத்தாலிய உணவு',
  ...
  te: {
      ...
      form: {
          ...
          preferencesPlaceholder: 'ఉదా., కారంగా, ఇటాలియన్ వంటకాలు',
  ...
  or: {
      ...
      form: {
          ...
          preferencesPlaceholder: 'ଯେପରି, ମସଲାଯୁକ୍ତ, ଇଟାଲୀୟ ରନ୍ଧନ',
  ...
  pa: {
      ...
      form: {
          ...
          preferencesPlaceholder: 'ਜਿਵੇਂ ਕਿ, ਮਸਾਲੇਦਾਰ, ਇਤਾਲਵੀ ਪਕਵਾਨ',
  ...
  ja: {
      ...
      form: {
          ...
          preferencesPlaceholder: '例：辛い、イタリア料理',
  ...
  es: {
    ...
    form: {
      ...
      preferencesPlaceholder: 'ej., picante, cocina italiana',
  ...
  fr: {
    ...
    form: {
      ...
      preferencesPlaceholder: 'ex: épicé, cuisine italienne',
